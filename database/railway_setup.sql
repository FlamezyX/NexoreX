-- NexoreX Railway Setup
-- Run this in your Railway database (already connected to 'railway' db)
...
CREATE TABLE IF NOT EXISTS users (
    ...
    seller_status ENUM('not_applied', 'pending', 'approved', 'rejected') NOT NULL DEFAULT 'not_applied',
...
CREATE TABLE IF NOT EXISTS promo_logs (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_promo_logs_admin FOREIGN KEY (admin_user_id) REFERENCES users(user_id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS seller_applications (
    ...
    CONSTRAINT fk_seller_applications_user FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    CONSTRAINT fk_orders_shipping FOREIGN KEY (shipping_option_id) REFERENCES shipping_options(shipping_option_id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS wallets (
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_wallets_seller FOREIGN KEY (seller_id) REFERENCES users(user_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    CONSTRAINT fk_transactions_seller FOREIGN KEY (seller_id) REFERENCES users(user_id) ON DELETE SET NULL,
    CONSTRAINT fk_transactions_buyer FOREIGN KEY (buyer_id) REFERENCES users(user_id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS withdrawal_requests (
    ...
    CONSTRAINT fk_withdrawal_seller FOREIGN KEY (seller_id) REFERENCES users(user_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS platform_earnings (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_platform_earnings_order FOREIGN KEY (order_id) REFERENCES orders(order_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS seller_reports (
    ...
    buyer_id INT NOT NULL,
    seller_id INT NOT NULL,
    reason ENUM('fake_listing','item_not_as_described','rude_behaviour','suspected_scam','other') NOT NULL,
    description TEXT NOT NULL,
